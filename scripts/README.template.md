...
| | Typical file-cropping component | {{PACKAGE_NAME}} |
|---|---|---|
...
<!-- include-snippet file="example/src/snippets/QuickStartExample.tsx" name="quick-start" lang="tsx" -->
...
import { getCropRect } from "{{PACKAGE_NAME}}";
import type { CropData, Size } from "{{PACKAGE_NAME}}";
